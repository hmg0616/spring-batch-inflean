...
import com.example.springbatchinflearn.finalExample.listener.ApiJobListener;
import com.example.springbatchinflearn.finalExample.tasklet.ApiEndTasklet;
import com.example.springbatchinflearn.finalExample.tasklet.ApiStartTasklet;
...
public class ApiJobConfiguration {
    ...
    private final Step childJobStep;
    ...
    public Job apiJob() {
        return jobBuilderFactory.get("apiJob")
                ...
                .start(apiStep1())
                .next(childJobStep) // Job에서 새로운 Job 실행
                .next(apiStep2())
                .build();
    }
