package com.example.springbatchinflearn.finalExample.job.file;

import com.example.springbatchinflearn.finalExample.chunk.processor.FileItemProcessor;
...
public class FileJobConfiguration {
    ...
    public FlatFileItemReader<ProductVO> fileItemReader(@Value("#{jobParameters['requestDate']}") String requestDate) {
        return new FlatFileItemReaderBuilder<ProductVO>()
                .name("flatFile")
                .resource(new ClassPathResource("/finalExample/product_" + requestDate + ".csv"))
