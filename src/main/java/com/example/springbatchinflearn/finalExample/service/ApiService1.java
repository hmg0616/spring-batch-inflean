...
public class ApiService1 extends AbstractApiService {
    ...
    protected ApiResponseVO doApiService(RestTemplate restTemplate, ApiInfo apiInfo) {
        ...
        // 원래는 다른 서버에서 8081 포트로 호출 - 나는 편의상 같은 서버에서 진행
        ResponseEntity<String> responseEntity = restTemplate.postForEntity("http://localhost:8080/product/1", apiInfo, String.class);
